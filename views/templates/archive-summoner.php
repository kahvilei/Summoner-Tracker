<link rel="stylesheet" href="<?php echo SUMMONER_TRACKER_URL; ?>assets/css/archive-summoner.css">
<link rel="script" href="<?php echo SUMMONER_TRACKER_URL; ?>assets/js/archive-summoner.js">
<?php
get_header();
...
if (have_posts()):
    while (have_posts()):
        ...
        echo '<a class="summoner_update_button" data-nonce="' . $nonce . '" data-post_id="' . $post->ID . '" href="' . '#' . '">update</a>';
        echo '</div>';
